...
DROP TABLE IF EXISTS `meal_description`;
...
) ENGINE=InnoDB AUTO_INCREMENT=1210 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table dbrhzbrqhhlw5g.meal_ingredients: ~204 rows (approximately)
REPLACE INTO `meal_ingredients` (`miID`, `mealID`, `ingredientID`, `quantity`, `unit`) VALUES
	(112, 32, 36, 0.50, 1),
	(113, 32, 4, 2.00, 18),
	(114, 32, 66, 2.00, 18),
	(115, 32, 67, 0.50, 3),
...
DROP TABLE IF EXISTS `quantity_options`;
...
REPLACE INTO `quantity_options` (`id`, `optionValue`, `textValue`) VALUES
	(1, 0.125, '1/8'),
	(2, 0.250, '1/4'),
	(3, 0.375, '3/8'),
	(4, 0.500, '1/2'),
