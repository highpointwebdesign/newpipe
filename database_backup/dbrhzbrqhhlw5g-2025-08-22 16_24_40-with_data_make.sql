...
-- Dumping data for table dbrhzbrqhhlw5g.categories: ~17 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `meals` (
  ...
  KEY `FK_meals_meal_types` (`mealTypeID`),
  CONSTRAINT `FK_meals_meal_types` FOREIGN KEY (`mealTypeID`) REFERENCES `meal_types` (`mealTypeID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table dbrhzbrqhhlw5g.meals: ~30 rows (approximately)
REPLACE INTO `meals` (`mealID`, `title`, `servings`, `created_at`, `mealTypeID`, `fav`, `isDeleted`, `recipe_id`, `details`, `uc`, `um`) VALUES
	...
	(39, 'Apples', 2, '2025-08-21 21:52:50', 1, 0, 0, NULL, '', '2025-08-21 21:52:50', '2025-08-22 02:53:08');

-- Dumping structure for table dbrhzbrqhhlw5g.meal_charms
DROP TABLE IF EXISTS `meal_charms`;
CREATE TABLE IF NOT EXISTS `meal_charms` (
  `charmID` int(11) NOT NULL AUTO_INCREMENT,
  `charmName` varchar(50) NOT NULL,
  `isDeleted` smallint(6) NOT NULL DEFAULT 0,
  PRIMARY KEY (`charmID`),
  UNIQUE KEY `charmName` (`charmName`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table dbrhzbrqhhlw5g.meal_charms: ~10 rows (approximately)
REPLACE INTO `meal_charms` (`charmID`, `charmName`, `isDeleted`) VALUES
	(1, 'fa fa-coffee', 0),
	(2, 'fa fa-cutlery', 0),
	(3, 'fas fa-pizza-slice', 0),
	(4, 'fas fa-hotdog', 0),
	(5, 'fas fa-cookie', 0),
	(6, 'fas fa-cheese', 0),
	(7, 'fas fa-carrot', 0),
	(8, 'fas fa-candy-cane', 0),
	(9, 'fas fa-bread-slice', 0),
	(10, 'fas fa-bacon', 0);
...
CREATE TABLE IF NOT EXISTS `meal_ingredients` (
  ...
  KEY `FK_meal_ingredients_measurementunits` (`unit`),
  KEY `FK_meal_ingredients_quantity_options` (`quantityID`),
  KEY `FK_meal_ingredients_raw_ingredients` (`ingredientID`),
  CONSTRAINT `FK_meal_ingredients_measurementunits` FOREIGN KEY (`unit`) REFERENCES `measurementunits` (`unitID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_meal_ingredients_quantity_options` FOREIGN KEY (`quantityID`) REFERENCES `quantity_options` (`quantityID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_meal_ingredients_raw_ingredients` FOREIGN KEY (`ingredientID`) REFERENCES `raw_ingredients` (`ingredientID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `meal_ingredients_ibfk_1` FOREIGN KEY (`mealID`) REFERENCES `meals` (`mealID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=1391 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table dbrhzbrqhhlw5g.meal_ingredients: ~202 rows (approximately)
REPLACE INTO `meal_ingredients` (`miID`, `mealID`, `ingredientID`, `unit`, `quantityID`) VALUES
	(112, 32, 36, 1, 4),
	(113, 32, 4, 18, 12),
	(114, 32, 66, 18, 12),
	(115, 32, 67, 3, 4),
...
CREATE TABLE IF NOT EXISTS `meal_types` (
  ...
  `charmID` int(11) DEFAULT NULL,
  `orderby` smallint(6) DEFAULT NULL,
  PRIMARY KEY (`mealTypeID`) USING BTREE,
  KEY `FK_meal_types_meal_charms` (`charmID`),
  CONSTRAINT `FK_meal_types_meal_charms` FOREIGN KEY (`charmID`) REFERENCES `meal_charms` (`charmID`) ON DELETE NO ACTION ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table dbrhzbrqhhlw5g.meal_types: ~5 rows (approximately)
REPLACE INTO `meal_types` (`mealTypeID`, `mealTypeName`, `mealTypeColor`, `charmID`, `orderby`) VALUES
	(1, 'Breakfast', '#5C3799', NULL, 10),
	(2, 'Lunch', '#1ab5ac', NULL, 20),
	(3, 'Dinner', '#2953E8', NULL, 30),
	(4, 'Dessert', '#ff887c', NULL, 40),
	(8, 'Sides and Sauces and Spices', '#9eeaf9', NULL, 500);
...
CREATE TABLE IF NOT EXISTS `measurementunits` (
  ...
  `isIndivisible` smallint(6) NOT NULL DEFAULT 1,
...
REPLACE INTO `measurementunits` (`unitID`, `unitName`, `baseUnit`, `unitType`, `isIndivisible`) VALUES
	(1, 'Teaspoon', 'tsp', 'volume', 1),
	(2, 'Tablespoon', 'Tbsp', 'volume', 1),
	(3, 'Cup', 'Cup', 'volume', 1),
	(4, 'Quart', 'qt', 'volume', 1),
	(6, 'Fluid Ounce', 'fl oz', 'volume', 1),
	(7, 'Pint', 'pt', 'volume', 1),
	(8, 'Gallon', 'gal', 'volume', 1),
	(16, 'Ounce', 'oz', 'weight', 1),
	(17, 'Pound', 'lb', 'weight', 1),
	(18, 'Each', 'unit', 'count', 0),
	(19, 'Can', 'Can', 'count', 0),
	(20, 'Pieces', 'pcs', 'count', 1);
