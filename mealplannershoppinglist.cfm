...
<cfparam name="local.isFormSubmit" default="1">
                                ...
                                <div class="form-check d-flex justify-content-between align-items-center">
                                    <div>
                                        <label class="form-check-label">
                                            #distinctMeals.title# (#distinctMeals.mealID#) <a href="/meal_crud.cfm?id=#distinctMeals.mealID#"><span class="flaticon-381-notepad"></span></a>
                                        </label>
                                    </div>
                  ...
                  <div id="bordered_no-gutter_collapseShoppingList" class="collapse accordion__body <cfif local.isFormSubmit eq 1>collapse show</cfif>" data-bs-parent="#accordion-ShoppingList" style="background-color: #ffffff;">
                    <div class="accordion__body--text">
                      <div id="shoppingList">
                        <cfif local.isFormSubmit eq 1>
                          <ul>
                          <cfoutput query="ingredientQry" group="ingredientID">
                            <!--- <li>#ingredientQry.textValue# #ingredientQry.baseUnit# of #ingredientQry.ingredient_name#</li> --->
                             <li class="list-group-item">
                                <div class="form-check d-flex justify-content-between align-items-center">
                                    <div>
                                        <label class="form-check-label">
                                          <input class="form-check-input item-checkbox" type="checkbox">&nbsp;#ingredientQry.textValue# #ingredientQry.baseUnit# of #ingredientQry.ingredient_name#<br/>
                                            <span class="muted">&nbsp;In Meals: 
                                              <cfset mealListIDs = ''>
                                              <cfoutput><cfset mealListIDs = listappend(mealListIDs, '#ingredientQry.mealID#')></cfoutput>
                                              #listRemoveDuplicates(mealListIDs)#</span>
